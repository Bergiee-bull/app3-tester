const CACHE = "app3-tester-v1.3.0";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./src/signal.js",
  "./src/storage.js",
  "./src/portfolio.js?v=1.3.0",
  "./src/asset_registry.js",
  "./src/charts.js?v=1.3.0",
  "./src/reconciliation.js?v=1.3.0",
  "./src/strategy_history.js?v=1.3.0",
  "./src/benchmark_data.js?v=1.3.0",
  "./src/market_status.js?v=1.3.0",
